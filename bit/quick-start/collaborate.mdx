...
Once you've created a new remote scope, to update it to be your default scope, use:

```
bit scope rename
```

And if you want the existing components in your workspace to be updated to the new scope name, add the 'refactor' flag like this:
